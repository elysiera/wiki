...
- **Exaltation Forge improvement:** Class 1 items can now be upgraded up Tier 3 (25k for Tier 1, 50k for Tier 2, 100k for Tier 3). Class 2 items can now be upgraded to Tier 4 (50k for Tier 1, 100k for Tier 2, 200k for Tier 3, 400k for Tier 4). Class 3 items can now be upgraded up Tier 5 (200k for Tier 1, 400k for Tier 2, 800k for Tier 3, 1.6m for Tier 4, 3.2m for Tier 5).
